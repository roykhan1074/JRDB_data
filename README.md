...
出馬表に表示される「穴馬指数」の詳細仕様については [document/指数/EX指数_仕様書.md](document/指数/EX指数_仕様書.md) を参照。

### 更新手順

1. `http://localhost:3000/download.html` を開く
2. ページ下部「穴馬指数 更新」→「穴馬指数を更新する」ボタンをクリック
3. Part 1〜4 が順次実行される（所要時間: 約3〜5分）

> SED（成績データ）取込後に実行するのが推奨タイミング。
